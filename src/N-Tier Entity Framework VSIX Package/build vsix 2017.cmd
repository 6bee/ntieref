...
MSBuild.exe "%~dp0\N-Tier Entity Framework VSIX Package.v15.sln" /target:Rebuild /verbosity:minimal /maxcpucount /nodeReuse:false /property:Configuration=Release;VsixVersion=1.9;NugetPackageVersion=1.9.1;VisualStudioVersion=15.0 %*
ENDLOCAL
ECHO.
PAUSE
