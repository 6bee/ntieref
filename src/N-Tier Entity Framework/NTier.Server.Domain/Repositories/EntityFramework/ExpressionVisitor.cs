...
namespace NTier.Server.Domain.Repositories.EntityFramework
{
    internal static class ExpressionVisitor
    {
        ...
        private sealed class SqlFunctions : NTier.Server.Domain.Repositories.Linq.Expressions.ExpressionVisitor
        {
            ...
            private static readonly MethodInfo StringConvertDecimal = typeof(System.Data.Objects.SqlClient.SqlFunctions).GetMethod("StringConvert", BindingFlags.Public | BindingFlags.Static, null, new[] { typeof(decimal?), typeof(int?), typeof(int?) }, null);
            private static readonly MethodInfo StringConvertDouble = typeof(System.Data.Objects.SqlClient.SqlFunctions).GetMethod("StringConvert", BindingFlags.Public | BindingFlags.Static, null, new[] { typeof(double?), typeof(int?), typeof(int?) }, null);
