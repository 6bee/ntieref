...
namespace NTier.Client.Domain
{
    ...
    {
        /// <summary>
        /// Default uses <see cref="AcceptChangesOnTransactionCompleted"/> in case of an active transaction, <see cref="AcceptChangesAfterSave"/> otherwise. (Default) 
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Changes are accepted automatically if transaction completes successfully.
        /// </summary>
        /// <remarks>
        /// This option requires an active transaction.
        /// </remarks>
        AcceptChangesOnTransactionCompleted = 4
    }
}
