...
namespace NTier.Client.Domain
{
    internal static class IOrderedDataServiceQueryableExtensions
    {
        ...
        public static IOrderedDataServiceQueryable<TEntity> ThenBy<TEntity>(this IOrderedDataServiceQueryable<TEntity> queriable, RLinq.SortExpression expression) where TEntity : Entity<TEntity>
        {
            var newQueriable = new OrderedDataServiceQueryable<TEntity>((OrderedDataServiceQueryable<TEntity>)queriable);
