...
echo.
%SystemRoot%\Microsoft.NET\Framework\v4.0.30319\msbuild "%~dp0\IntegrationTest.sln" /v:minimal /maxcpucount /nodeReuse:false /target:Rebuild /p:Configuration=Debug %*
::
::
echo.
echo.
