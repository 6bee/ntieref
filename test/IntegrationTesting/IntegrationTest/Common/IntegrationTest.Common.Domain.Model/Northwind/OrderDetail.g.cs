...
namespace IntegrationTest.Common.Domain.Model.Northwind
{
    ...
    public partial class OrderDetail : Entity<OrderDetail>, INotifyPropertyChanged, INotifyPropertyChanging, IDataErrorInfo
    {
        ...
        public Order Order
        {
            ...
            set
            {
                if (!object.ReferenceEquals(_order, value))
                {
                    OrderChanging(value);
        ...
        public Product Product
        {
            ...
            set
            {
                if (!object.ReferenceEquals(_product, value))
                {
        ...
        private void FixupOrder(Order previousValue)
        {
            ...
            if (ChangeTracker.IsChangeTrackingEnabled)
            {
                if (ChangeTracker.OriginalValues.ContainsKey("Order")
                    && object.ReferenceEquals(ChangeTracker.OriginalValues["Order"], Order))
                {
        ...
        private void FixupProduct(Product previousValue)
        {
            ...
            if (ChangeTracker.IsChangeTrackingEnabled)
            {
                if (ChangeTracker.OriginalValues.ContainsKey("Product")
                    && object.ReferenceEquals(ChangeTracker.OriginalValues["Product"], Product))
                {
        ...
        protected override bool IsKeyEqual(OrderDetail entity)
        {
