...
namespace IntegrationTest.Common.Domain.Model.Northwind
{
    ...
    public partial class Region : Entity<Region>, INotifyPropertyChanged, INotifyPropertyChanging, IDataErrorInfo
    {
        ...
        private void FixupTerritories(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (object.ReferenceEquals(item.Region, this))
                    {
                        item.Region = null;
                    }
                    if (ChangeTracker.IsChangeTrackingEnabled)
        ...
        protected override bool IsKeyEqual(Region entity)
        {
