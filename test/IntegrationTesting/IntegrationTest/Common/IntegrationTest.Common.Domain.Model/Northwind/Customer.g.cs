...
namespace IntegrationTest.Common.Domain.Model.Northwind
{
    ...
    public partial class Customer : Entity<Customer>, INotifyPropertyChanged, INotifyPropertyChanging, IDataErrorInfo
    {
        ...
        public TrackableCollection<DemographicGroup> CustomerDemographics
        {
            ...
            set
            {
                if (!object.ReferenceEquals(_customerDemographics, value))
                {
                    if (!IsDeserializing && ChangeTracker.IsChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
        ...
        private void FixupOrders(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (object.ReferenceEquals(item.Customer, this))
                    {
                        item.Customer = null;
                    }
                    if (ChangeTracker.IsChangeTrackingEnabled)
        ...
        {
            return ReferenceEquals(this.CustomerID, null) ? 0 : this.CustomerID.GetHashCode();
        }
    }
}
