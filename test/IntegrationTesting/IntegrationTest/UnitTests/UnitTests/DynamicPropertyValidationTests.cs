...
namespace UnitTests
{
    ...
    public class DynamicPropertyValidationTests : AssertionHelper
    {
        ...
        {
            DynamicContentEntity.RegisterValidator(DYNAMIC_PROPERTY, new TestValidationAttribute());
        }

        [Test]
        public void T2_RegisterValidatorForPhysicalProperty()
        {
            DynamicContentEntity.RegisterValidator(PHYSICAL_PROPERTY, new TestValidationAttribute());
        }
        ...
        {
            var result = DynamicContentEntity.UnregisterValidator(DYNAMIC_PROPERTY, new TestValidationAttribute());
        ...
        {
            var result = DynamicContentEntity.UnregisterValidator(PHYSICAL_PROPERTY, new TestValidationAttribute());
            Expect(result, Is.True);
        }
