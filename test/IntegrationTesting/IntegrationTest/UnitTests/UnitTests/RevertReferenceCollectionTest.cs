...
namespace UnitTests
{
    ...
    public class RevertReferenceCollectionTest : AssertionHelper
    {
        ...
        public void T1_RevertReferenceCollection()
        {
            ...
            var customerGroup1 = ctx.CustomerDemographics.AsQueryable().Single(g => g.ID == GROUP1_ID);
            var customerGroup2 = ctx.CustomerDemographics.AsQueryable().Single(g => g.ID == GROUP2_ID);
