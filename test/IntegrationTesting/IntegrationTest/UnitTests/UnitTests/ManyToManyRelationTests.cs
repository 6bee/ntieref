...
namespace UnitTests
{
    ...
    public class ManyToManyRelationTests : AssertionHelper
    {
        ...
        {
            var male = new DemographicGroup { ID = "DemoGroup5", CustomerDesc = "Male" };
            var female = new DemographicGroup { ID = "DemoGroup6", CustomerDesc = "Female" };

            var smoker = new DemographicGroup { ID = "DemoGroup7", CustomerDesc = "Smoker" };
            var noSmoker = new DemographicGroup { ID = "DemoGroup8", CustomerDesc = "NoSmoker" };

            var undefined = new DemographicGroup { ID = "DemoGroup9", CustomerDesc = "Undefined" };
        ...
        public void T1_CreateSingleRelation(string customerId, string customerName, string groupId, string groupDesc)
        {
            ...
            var group = new DemographicGroup { ID = groupId, CustomerDesc = groupDesc };
        ...
        public void T2_DeleteSingleRelation()
        {
            ...
            Expect(customer.CustomerDemographics.First().ID, Is.EqualTo("DemoGroup0"));
            ...
            Expect(ctx.CustomerDemographics.Count(), Is.EqualTo(1));
            Expect(ctx.CustomerDemographics.Single().ID, Is.EqualTo("DemoGroup0"));
            Expect(object.ReferenceEquals(ctx.CustomerDemographics.Single(), group));
        ...
        public void T3_CascadeDeleteSingleRelation()
        {
            ...
            group = ctx.CustomerDemographics
                .AsQueryable()
                .Single(g => g.ID == "DemoGroup1");
        ...
        public void T5_ValidateEntitiesWithMultipleRelations(string customerId, string[] groupIds)
        {
            ...
            {
                Expect(groupIds, Contains(group.ID));
            }
        }
        ...
        public void T6_ValidateEntitiesWithMultipleRelations(string groupId, string[] customerIds)
        {
            ...
            var group = ctx.CustomerDemographics
                .AsQueryable()
                .Include("Customers")
        ...
        public void T7_CheckDemographicsExistance([Values("DemoGroup5", "DemoGroup6", "DemoGroup7", "DemoGroup8", "DemoGroup9")] string id)
        {
            ...
            var count = ctx.CustomerDemographics
                .AsQueryable()
                .Count(g => g.ID == id);
        ...
        public void T8_DeleteAll()
        {
            ...
            ctx.CustomerDemographics
                .AsQueryable()
                .Where(g => g.ID.StartsWith("DemoGroup"))
                .Execute();
