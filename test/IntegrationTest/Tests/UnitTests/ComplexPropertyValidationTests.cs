...
namespace UnitTests
{
    ...
    public class ComplexPropertyValidationTests : AssertionHelper
    {
        ...
        public void T1_SetToLongString()
        {
            ...
            Customer.RegisterValidator(typeof(Customer), "Contact.City", StringLengthAttribute);
        ...
        public void T4_RemoveValidator()
        {
            ...
            Customer.UnregisterValidator(typeof(Customer), "Contact.City", StringLengthAttribute);
