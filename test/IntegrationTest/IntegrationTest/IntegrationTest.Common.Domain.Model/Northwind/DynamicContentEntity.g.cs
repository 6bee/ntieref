...
namespace IntegrationTest.Common.Domain.Model.Northwind
{
    ...
    public partial class DynamicContentEntity : Entity, INotifyPropertyChanged, INotifyPropertyChanging, IDataErrorInfo
    {
        ...
        {
            var entity = other as DynamicContentEntity;
