...
namespace ConcurrencyDemo.Common.Domain.Model.ConcurrencyTest
{
    ...
    public partial class ConcurrencyTestChangeSet : IChangeSet
    {
        ...
        public ConcurrencyTestChangeSet(IEnumerable<ARecord> aRecords, IEnumerable<BRecord> bRecords)
        {
            ...
            this.FixupRelations(
                this.Union(aRecordsMap.CastToEntityTuple(), bRecordsMap.CastToEntityTuple()),
                this.Union(aRecordChangeSet, bRecordChangeSet)
            );
