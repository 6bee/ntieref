...
{
    [MetadataType(typeof(CRecordMetadata))]
    partial class CRecord
    {
    }

    // This class allows you to attach custom attributes to properties of the CRecord class.
    //
    ...
    //    [StringLength(32)]
    //    string Xyz;
    public sealed class CRecordMetadata
    {
        // this class is not meant to be instantiated by client code
        private CRecordMetadata() { }
...
#pragma warning disable 0169
        ...
        // Note: this property is set by database stored procedure (see edmx table mapping) on save operation for added and modified entities
