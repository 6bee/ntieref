...
{
    [MetadataType(typeof(BRecordMetadata))]
    partial class BRecord
    {
    }

    // This class allows you to attach custom attributes to properties of the BRecord class.
    //
    ...
    //    [StringLength(32)]
    //    string Xyz;
    public sealed class BRecordMetadata
    {
        // this class is not meant to be instantiated by client code
        private BRecordMetadata() { }
