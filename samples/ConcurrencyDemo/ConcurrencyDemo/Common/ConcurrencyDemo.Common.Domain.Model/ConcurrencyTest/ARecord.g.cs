...
namespace ConcurrencyDemo.Common.Domain.Model.ConcurrencyTest
{
    ...
    public partial class ARecord : Entity<ARecord>, INotifyPropertyChanged, INotifyPropertyChanging, IDataErrorInfo
    {
        ...
        protected override bool IsKeyEqual(ARecord entity)
        {
