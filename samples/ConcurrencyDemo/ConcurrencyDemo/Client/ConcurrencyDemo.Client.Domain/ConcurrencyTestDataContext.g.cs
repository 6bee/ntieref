...
namespace ConcurrencyDemo.Client.Domain
{
    public sealed partial class ConcurrencyTestDataContext : DataContext<ConcurrencyTestResultSet>, IConcurrencyTestDataContext
    {
        ...
        private readonly Func<IConcurrencyTestChangeSetFactory> _changeSetFactoryProvider;
        ...
        public ConcurrencyTestDataContext(IChannelFactory<IConcurrencyTestDataService> channelFactory, Func<IConcurrencyTestChangeSetFactory> changeSetFactoryProvider = null)
            : this(channelFactory.CreateChannel, changeSetFactoryProvider)
        {
        }

        public ConcurrencyTestDataContext(string endpointConfigurationName = "ConcurrencyTestDataService", Func<IConcurrencyTestChangeSetFactory> changeSetFactoryProvider = null)
        ...
        public IEntitySet<ARecord> ARecords
        {
            get
            {
                if (ReferenceEquals(null, aRecordEntitySet))
                {
                    aRecordEntitySet = CreateEntitySet<ARecord>(_aRecords, AttachWithRelations, OnDetach, GetARecords);
                }
        ...
        private void OnDetach(ARecord entity)
        {
        }
        ...
        public IEntitySet<BRecord> BRecords
        {
            get
            {
                if (ReferenceEquals(null, bRecordEntitySet))
                {
                    bRecordEntitySet = CreateEntitySet<BRecord>(_bRecords, AttachWithRelations, OnDetach, GetBRecords);
                }
        ...
        public IEntitySet<CRecord> CRecords
        {
            get
            {
                if (ReferenceEquals(null, cRecordEntitySet))
                {
                    cRecordEntitySet = CreateEntitySet<CRecord>(_cRecords, AttachWithRelations, OnDetach, GetCRecords);
                }
        ...
        private void OnDetach(CRecord entity)
        {
        }
        ...
        protected override void Refresh(ConcurrencyTestResultSet resultSet)
        {
            lock (_aRecords.SyncRoot)
            {
                Refresh(_aRecords, resultSet.ARecords);
            }

            lock (_bRecords.SyncRoot)
            {
                Refresh(_bRecords, resultSet.BRecords);
            }

            lock (_cRecords.SyncRoot)
            {
                Refresh(_cRecords, resultSet.CRecords);
            }
