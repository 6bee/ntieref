...
using ProductManager.WPF.Applications;
using System.Waf;
...
namespace ProductManager.WPF.Presentation
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            // Add the ProductManager.WPF.Presentation assembly to the catalog
            catalog.Catalogs.Add(new AssemblyCatalog(Assembly.GetExecutingAssembly()));
            // Add the ProductManager.WPF.Applications assembly to the catalog
        ...
        private static void HandleException(Exception e, bool isTerminating)
        {
            ...
            if (!isTerminating)
            {
                MessageBox.Show(string.Format(CultureInfo.CurrentCulture,
                        ProductManager.WPF.Presentation.Properties.Resources.UnknownError, e.ToString()), 
