...
namespace ProductManager.Common.Domain.Model.ProductManager
{
    ...
    public sealed partial class ProductManagerResultSet : ProductManagerChangeSet, IResultSet
    {
        ...
        [DataMember]
        public IList<Product> ProductConcurrencyConflicts { get; /*private (must be public in silverlight)*/ set; }

        [DataMember]
        public IList<ProductCategory> ProductCategoryConcurrencyConflicts { get; /*private (must be public in silverlight)*/ set; }
