...
namespace NTierDemo.Common.Domain.Model.NTierDemo
{
    ...
    public partial class PostInfo : Entity<PostInfo>, INotifyPropertyChanged, INotifyPropertyChanging, IDataErrorInfo
    {
...
#endif
        [SimpleProperty]
        internal global::System.Int64 BlogId
        {
            get { return _blogId; }
            set
            {
        ...
        protected override bool IsKeyEqual(PostInfo entity)
        {
